import { defineComponent as u, resolveComponent as h, openBlock as t, createBlock as n, mergeProps as C, withCtx as i, createElementBlock as l, Fragment as w, renderList as M, resolveDynamicComponent as g, unref as f, createCommentVNode as m, createElementVNode as e, toDisplayString as x, useAttrs as y, createVNode as s, isVNode as B } from "vue";
const z = (a) => a.replace(/([A-Z])/g, "$1").toLowerCase(), L = /* @__PURE__ */ u({
  __name: "index",
  props: {
    // 导航菜单的数据
    data: {
  ...
  setup(a) {
    return (r, _) => {
      const c = h("el-menu-item"), v = h("el-sub-menu"), p = h("el-menu");
      return t(), n(p, C({
        ...
        default: i(() => [
          (t(!0), l(
            ...
            M(a.data, (o, H) => (t(), l(
              ...
              { key: H },
              [
                !o[a.children] || !o[a.children].length ? (t(), n(c, {
                  key: 0,
                  index: o[a.index]
                }, {
                  default: i(() => [
                    o[a.icon] ? (t(), n(g(`el-icon-${f(z)(o[a.icon])}`), { key: 0 })) : m("v-if", !0),
                    e(
                      "span",
                      null,
                      x(o[a.name]),
                ...
                o[a.children] && o[a.children].length ? (t(), n(v, {
                  key: 1,
                  index: o[a.index]
                }, {
                  title: i(() => [
                  ...
                  default: i(() => [
                    (t(!0), l(
                      w,
                      null,
                      M(o[a.children], (d, V) => (t(), n(c, {
                        key: V,
                        index: d.index
                      }, {
                        default: i(() => [
                          d[a.icon] ? (t(), n(g(`el-icon-${f(z)(d[a.icon])}`), { key: 0 })) : m("v-if", !0),
                          e(
                            "span",
                            null,
                            x(d[a.name]),
...
const A = (a, r) => {
  ...
  for (const [c, v] of r)
    _[c] = v;
  return _;
}, k = /* @__PURE__ */ A(L, [["__scopeId", "data-v-548049a9"]]);
...
const C_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChromeFilled: d0,
  CircleCheck: x0,
  CircleCheckFilled: g0,
  CircleClose: H0,
  CircleCloseFilled: M0,
  CirclePlus: L0,
  CirclePlusFilled: y0,
  Clock: k0,
  Close: F0,
...
function H_(a) {
  return typeof a == "function" || Object.prototype.toString.call(a) === "[object Object]" && !B(a);
}
const V_ = /* @__PURE__ */ u({
  props: {
    // 导航菜单的数据
  ...
  setup(a, r) {
    const _ = (v) => v.map((p) => {
      p.i = C_[p[a.icon]];
      const o = {
        title: () => s(w, null, [s(p.i, null, null), s("span", null, [p[a.name]])])
      };
      return p[a.children] && p[a.children].length ? s(h("el-sub-menu"), {
        index: p[a.index]
      }, {
        default: () => [_(p[a.children])],
        ...o
      }) : s(h("el-menu-item"), {
        index: p[a.index]
      }, o);
  ...
  install(a) {
    a.component("m-menu", k), a.component("m-infinite-menu", V_);
  }
};
export {
  B_ as default
